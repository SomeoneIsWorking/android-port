...
public final class AndroidImportLifetimeTest {
    private static final class Host implements AndroidImportLifetime.Host<String> {
    ...
    private static void idleAndLateCallbacksCannotStartService() {
        Host host = new Host();
        AndroidImportLifetime<String> lifetime = new AndroidImportLifetime<>(host);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Android import lifetime: 4 scenarios passed (idle, handoff, cancel, refusal)");
    }
}
