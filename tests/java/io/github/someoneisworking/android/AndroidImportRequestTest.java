...
public final class AndroidImportRequestTest {
    ...
    public static void main(String[] args) {
        ...
        AndroidImportRequest<Object> old = new AndroidImportRequest<>();
        old.begin(42, true, oldActivity);
        AndroidImportRequest.Snapshot saved = old.snapshot();
        check(saved != null && saved.code == 42 && saved.tree);
        AndroidImportRequest<Object> recreated = new AndroidImportRequest<>();
        recreated.restore(new AndroidImportRequest.Snapshot(saved.code, saved.tree), newActivity);
        ...
        recreated.restore(new AndroidImportRequest.Snapshot(44, false), newActivity);
        try {
