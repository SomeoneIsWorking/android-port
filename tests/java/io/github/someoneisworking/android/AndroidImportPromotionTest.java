...
public final class AndroidImportPromotionTest {
    ...
    private static void rejected(File stage, File selected, File game, File previous) throws IOException {
        ...
        try {
            AndroidImportPromotion.publish(stage, selected, game, previous);
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            AndroidImportPromotion.publish(stage, stage, game, previous);
            ...
            AndroidImportPromotion.publish(stage, nested, game, previous);
            ...
            System.out.println("Android import publication: whole/nested and four refusals passed");
        } finally {
